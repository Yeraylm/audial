...
const TRANSLATIONS = {
  es: {
    ...
    'hero.badge':            'Whisper · Groq Llama 3.3 · RAG · Big Data Medallion',
    'hero.title.pre':        'Transforma',
    'hero.title.mid':        'horas de audio',
    'hero.title.post':       'en',
    'hero.title.italic':     'conocimiento estructurado',
    'hero.sub':              'Transcripción automática con Whisper, análisis semántico con Llama 3.3 70B, búsqueda vectorial RAG y asistente conversacional. Arquitectura Big Data Medallion desplegada en la nube.',
    ...
    'features.whisper.title': 'Whisper ASR',
    'features.whisper.desc':  'faster-whisper en CPU con VAD, beam search y detección automática de idioma — hasta 97 idiomas.',
    'features.diar.title':    'Diarización',
    'features.diar.desc':     'Detección automática de hablantes mediante análisis temporal de pausas y segmentación del audio.',
    'features.llm.title':     'Groq LLM',
    'features.llm.desc':      'Llama 3.3 70B vía Groq API — resúmenes jerárquicos, entidades, tareas, sentimiento, timeline y más.',
    'features.rag.title':     'Búsqueda RAG',
    'features.rag.desc':      'Embeddings multilingües (MiniLM-L12) indexados en ChromaDB para recuperación semántica precisa.',

    'bigdata.label':          'Arquitectura Big Data',
    'bigdata.title.pre':      'Pipeline',
    'bigdata.title.italic':   'Medallion',
    'bigdata.title.post':     'en la nube',
    'bigdata.desc':           'ETL Bronze → Silver → Gold con manifest Parquet. Procesamiento asíncrono por fases con gestión de estados, reintentos y exportación analítica.',
    'bigdata.bronze.desc':    'Audios crudos · manifest Parquet',
    'bigdata.silver.desc':    'Transcripciones · diarización · limpieza',
    'bigdata.gold.desc':      'Análisis estructurado · agregados BI',
    ...
    'chat.label':        'Asistente RAG',
    'chat.title':        'Asistente sobre tus audios',
    'chat.sub':          'Respuestas ancladas exclusivamente en tus transcripciones, generadas con Llama 3.3 70B a través de Groq.',
    ...
    'auth.code_screen':         'El email no pudo enviarse (modo demo). Usa el código que aparece a continuación:',
    ...
    'audio.file.unavail':       'Archivo de audio no disponible (servidor reiniciado). El análisis sigue accesible.',
    'audio.reupload':           'Re-subir audio',
    'audio.reuploading':        'Subiendo audio…',
  ...
  en: {
    ...
    'hero.sub':              'Automatic transcription with Whisper, semantic analysis with Llama 3.3 70B, RAG vector search and a conversational assistant. Big Data Medallion architecture deployed in the cloud.',
    ...
    'features.whisper.title': 'Whisper ASR',
    'features.whisper.desc':  'faster-whisper on CPU with VAD, beam search and automatic language detection — up to 97 languages.',
    'features.diar.title':    'Diarization',
    'features.diar.desc':     'Automatic speaker change detection through temporal pause analysis and audio segmentation.',
    'features.llm.title':     'Groq LLM',
    'features.llm.desc':      'Llama 3.3 70B via Groq API — hierarchical summaries, entities, tasks, sentiment, timeline and more.',
    'features.rag.title':     'RAG Search',
    'features.rag.desc':      'Multilingual embeddings (MiniLM-L12) indexed in ChromaDB for precise semantic retrieval.',

    'bigdata.label':          'Big Data Architecture',
    'bigdata.title.pre':      'Medallion',
    'bigdata.title.italic':   'Pipeline',
    'bigdata.title.post':     'in the cloud',
    'bigdata.desc':           'Bronze → Silver → Gold ETL with Parquet manifest. Async phase-based processing with state management, retries and analytical export.',
    ...
    'chat.label':        'RAG Assistant',
    'chat.title':        'Assistant over your audios',
    'chat.sub':          'Answers grounded exclusively in your transcripts, generated with Llama 3.3 70B via Groq.',
    ...
    'auth.code_screen':         'Email could not be sent (demo mode). Use the code shown below:',
    ...
    'audio.delete':             'Delete',
    'audio.file.unavail':       'Audio file not available (server restarted). Analysis is still accessible.',
    'audio.reupload':           'Re-upload audio',
    'audio.reuploading':        'Uploading audio…',
